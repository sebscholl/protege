...
8. Relay delivery-signal timeout is treated as queued/indeterminate (with timeout log event) to avoid duplicate outbound resends when relay confirmation is delayed.

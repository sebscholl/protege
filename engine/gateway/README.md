...
4. If inbound recipient routing does not resolve to a known persona, SMTP ingestion is rejected.
5. Outbound replies include deterministic threading headers.

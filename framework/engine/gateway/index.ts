...
import { parseRelayTunnelFrame } from '@engine/shared/relay-tunnel';
import { createUnifiedLogger } from '@engine/shared/logger';
import { readEmailAddressDomain, isValidEmailAddress } from '@engine/shared/email';
import {
  listPersonas,
  readPersonaMetadata,
...
import {
  ...
  readAttachmentCountFromRuntimePayload,
  readAttachmentNamesFromRuntimePayload,
  toStringArray,
...
import { runGlobRuntimeAction } from '@extensions/tools/glob/runtime-action';
import { runReadFileRuntimeAction } from '@extensions/tools/read-file/runtime-action';
import { runSearchRuntimeAction } from '@extensions/tools/search/runtime-action';
import { runWriteFileRuntimeAction } from '@extensions/tools/write-file/runtime-action';
import {
  runShellExecRuntimeAction,
} from '@extensions/tools/shell/runtime-action';
import { runWebFetchRuntimeAction } from '@extensions/tools/web-fetch/runtime-action';
import { runWebSearchRuntimeAction } from '@extensions/tools/web-search/runtime-action';
...
export { runEditFileRuntimeAction } from '@extensions/tools/edit-file/runtime-action';
export { runGlobRuntimeAction } from '@extensions/tools/glob/runtime-action';
export { runReadFileRuntimeAction } from '@extensions/tools/read-file/runtime-action';
export { runSearchRuntimeAction } from '@extensions/tools/search/runtime-action';
export { runWriteFileRuntimeAction } from '@extensions/tools/write-file/runtime-action';
export {
  executeShellCommand,
  resolveShellArgs,
...
export type { ShellExecRuntimeResult } from '@extensions/tools/shell/runtime-action';
export { runWebFetchRuntimeAction } from '@extensions/tools/web-fetch/runtime-action';
export { runWebSearchRuntimeAction } from '@extensions/tools/web-search/runtime-action';
export type { WebSearchResult } from '@extensions/tools/web-search/runtime-action';
export type { RipgrepExecFileSync } from '@extensions/tools/shared/ripgrep';
...
export function resolvePersonaSenderAddress(
  ...
  if (!isValidEmailAddress({ value: persona.emailAddress, allowLocalhost: true })) {
    throw new Error('Unable to resolve persona sender address for email.send runtime action.');
  }

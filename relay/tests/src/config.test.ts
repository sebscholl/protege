...
import { createRelayTestWorkspaceFromFixture } from '@tests/helpers/workspace';

let workspace!: ReturnType<typeof createRelayTestWorkspaceFromFixture>;
let defaultHost = '';
...
beforeAll((): void => {
  workspace = createRelayTestWorkspaceFromFixture({
